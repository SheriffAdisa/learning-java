...
public class Player {
  ...
  /* EXERCISE - Take the player class from the
    classMethods Exercise, and add a second constructor
    to call the same code to show the use of the 'this' keyword.
  */
  ...
  //Create a single parameter constructor
  public Player(String name) { 
    this(name, 100); //Use this() method to set default health to 100
  }  
  
  //Create a double parameter constructor
